...
export interface ICronusTimeOracleInterface extends utils.Interface {
  functions: {
...
export interface ICronusTimeOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICronusTimeOracleInterface;
