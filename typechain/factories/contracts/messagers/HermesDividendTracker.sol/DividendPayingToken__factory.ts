...
} from "../../../../contracts/messagers/HermesDividendTracker.sol/DividendPayingToken";
...
export class DividendPayingToken__factory extends ContractFactory {
  ...
  override attach(address: string): DividendPayingToken {
    return super.attach(address) as DividendPayingToken;
  }
  override connect(signer: Signer): DividendPayingToken__factory {
