...
} from "../../../../contracts/metastocks/managers/MetaCompanyManager";
...
type MetaCompanyManagerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MetaCompanyManagerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MetaCompanyManager__factory extends ContractFactory {
  constructor(...args: MetaCompanyManagerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): MetaCompanyManager {
    return super.attach(address) as MetaCompanyManager;
  }
  override connect(signer: Signer): MetaCompanyManager__factory {
