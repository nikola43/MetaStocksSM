...
} from "../../../../contracts/metastocks/managers/MetaShareManager";
...
type MetaShareManagerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MetaShareManagerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MetaShareManager__factory extends ContractFactory {
  constructor(...args: MetaShareManagerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): MetaShareManager {
    return super.attach(address) as MetaShareManager;
  }
  override connect(signer: Signer): MetaShareManager__factory {
