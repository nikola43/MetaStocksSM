...
} from "../../../../../contracts/midas/interfaces/avalanche/IPangolinRouter";
...
export class IPangolinRouter__factory {
  ...
  static createInterface(): IPangolinRouterInterface {
    return new utils.Interface(_abi) as IPangolinRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPangolinRouter {
    return new Contract(address, _abi, signerOrProvider) as IPangolinRouter;
  }
}
